  ...
  head: () => ({
    meta: [
      { title: "Terms of Service — FlashLocum" },
      {
        name: "description",
        content:
          "Terms of Service for the FlashLocum platform. Read how we connect verified locum doctors with healthcare professionals.",
      },
      ...
      <div className="mx-auto max-w-2xl px-6 py-10">
        ...
        <div className="mt-8 space-y-8 text-[14px] leading-relaxed text-foreground">
          <p className="text-muted-foreground">
            These Terms of Service ("Terms") govern your use of the FlashLocum platform
            ("FlashLocum", "we", "us", "our"), a real-time locum coordination platform that connects
            verified post-NYSC medical doctors with healthcare professionals who require temporary
            locum cover.
          </p>
          <p className="text-muted-foreground">
          ...
          <section>
            ...
            <p className="mt-2 text-muted-foreground">
              FlashLocum is a technology platform that enables users to:
            </p>
            ...
            <p className="mt-2 text-muted-foreground">
              FlashLocum is not a hospital, medical provider, employer, or recruitment agency. We do
              not employ doctors or control medical services provided during shifts.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2 text-muted-foreground">
              We reserve the right to verify, approve, or suspend accounts.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2 text-muted-foreground">
              FlashLocum only provides a coordination platform. We do not:
            </p>
            <ul className="mt-2 list-disc space-y-1 pl-5 text-muted-foreground">
            ...
            <p className="mt-2 text-muted-foreground">
              All medical services are provided independently by doctors.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2 text-muted-foreground">
              Users may request or book locum cover through the platform. Doctors may choose to
              accept or decline requests. A booking is only confirmed when a doctor accepts the
              request.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2 text-muted-foreground">
              Users may be rated after shifts. Ratings reflect performance feedback. Reliability
              reflects cancellation and attendance behaviour. FlashLocum may use these metrics to
              improve platform trust and matching. We reserve the right to adjust rating
              calculations for fairness and abuse prevention.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2 text-muted-foreground">
              Users may cancel bookings subject to platform rules. Repeated cancellations may impact
              reliability scores and access to the platform.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2 text-muted-foreground">
              We may update these Terms at any time. Continued use means acceptance of updated
              Terms.
            </p>
          </section>
