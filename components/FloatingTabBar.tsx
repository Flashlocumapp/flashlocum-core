...
export default function FloatingTabBar({
  ...
  const dynamicStyles = {
    blurContainer: {
      ...
      ...Platform.select({
        ios: {
          backgroundColor: theme.dark ? "rgba(28, 28, 30, 0.8)" : "rgba(255, 255, 255, 0.6)",
        },
        android: {
          backgroundColor: theme.dark ? "rgba(28, 28, 30, 0.95)" : "rgba(255, 255, 255, 0.6)",
        },
        web: {
          backgroundColor: theme.dark ? "rgba(28, 28, 30, 0.95)" : "rgba(255, 255, 255, 0.6)",
  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={["bottom"]}>
      ...
      >
        <BlurView intensity={80} style={[dynamicStyles.blurContainer, { borderRadius }]}>
